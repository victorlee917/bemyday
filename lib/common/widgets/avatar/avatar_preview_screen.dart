...
class AvatarPreviewScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _section('1 member', _mock(1), 80),
            _section('2 members', _mock(2), 80),
            _section('3 members', _mock(3), 80),
            _section('4 members', _mock(4), 80),
            _section('5 members (3 + \"+2\")', _mock(5), 80),
            _section('7 members (3 + \"+4\")', _mock(7), 80),
            ...
            Row(
              ...
              children: [
                _sizeDemo('40px', _mock(3), 40),
                _sizeDemo('60px', _mock(3), 60),
                _sizeDemo('80px', _mock(3), 80),
                _sizeDemo('120px', _mock(3), 120),
              ],
            ),
          ],
        ),
  ...
  Widget _section(
    ...
    return Padding(
      ...
      child: Row(
        children: [
          AvatarDividedCircle(members: members, diameter: diameter),
